...
import ui.turtleImage.TurtlePane;
...
public class WorkspacePage extends PageAbstract implements UIComponent, UIAPI{
	...
	myTurtleViewer = new TurtleViewer(TURTLE_VIEWER_WIDTH, TURTLE_VIEWER_HEIGHT,
		DEFAULT_BACKGROUND_COLOR, DEFAULT_PEN_COLOR, myTurtlePane);
	...
	myTurtlePane.initialize(myTurtleViewer);
    ...
    private void addImageToPane() {
    	root.add(myTurtlePane.getTopLevelNode(), 2, 2, 2, 4);
    }
